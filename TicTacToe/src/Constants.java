/**
 * Provides a central repository of constant values used across the tic-tac-toe game application.
 *
 * This class includes constants for various messages used in the game.
 */
