...
/**
 * A class that is used to convert a character to a boolean array that represents the character's image.
 */
public class CharConverter {
    ...
    /**
     * The default resolution of the image in pixels.
     */
     ...
     * constructor to a square black and white, image (2D array of booleans).
     *
     * @param c the character to render
     * @return a 2D array of booleans, representing the character's image
     */
